package com.thinklab.platform.mining.recommendations.collaborativeFiltering.contentbased;

import java.util.Collection;
import javax.security.auth.Refreshable;
import org.apache.mahout.cf.taste.impl.common.FastIDSet;

public class ContentBasedByMahoutExtention {
	private final FastIDSet men;
	private final FastIDSet women;
	
	public ContentBasedByMahoutExtention(FastIDSet men, FastIDSet women) {
		this.men = men;
		this.women = women;
	}
